    ...
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form id="twoStepsForm" class="mb-3" action="{{ $otp ? route('institution/verify_otp') : route('institution/login') }}" method="POST">
            @csrf
            @method('post')
            @if ($mobile)
            <h6 class="mb-2">Welcome to Institution Login! 👋</h6>
