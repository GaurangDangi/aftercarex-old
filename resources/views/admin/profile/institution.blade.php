  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        @endif
        <form id="addTemplateForm" method="POST" action="{{ route('updateProfile',$institution['id']) }}" class="row g-3" enctype="multipart/form-data">
          @csrf

          <div class="col-md-12">
            
            <label for="formValidationFile" class="form-label">Profile Pic</label>
            <?php if($institution['image_url']!=''){?>
              <img src="{{ asset($institution['image_url'])}}" alt="<?=$institution['name'];?>" style=" max-width: 100%; height: auto;">
            <?php } ?>
