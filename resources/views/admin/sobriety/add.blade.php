...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      <h5 class="card-header">Add Testing</h5>
      <div class="card-body">
        <form id="addTemplateForm" method="POST" action="{{route('storeSobriety')}}" class="row g-3" enctype="multipart/form-data">@csrf
          ...
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="formValidationBio" name="rules" rows="3">{{ old('rules') }}</textarea>
            @if ($errors->has('rules'))
