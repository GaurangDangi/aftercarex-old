...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      <h5 class="card-header">Edit Group Class</h5>
      <div class="card-body">
        <form id="addTemplateForm" method="POST" action="{{ route('updateClassSetup',$class['id']) }}" class="row g-3" enctype="multipart/form-data">
          @csrf

          <div class="col-md-6">
            @php $speaker_id = old('speaker_id') ? old('speaker_id') : $class['speaker_id']; @endphp
          ...
          <div class="col-md-6">
            @php $title = old('title') ? old('title') : $class['title']; @endphp
          ...
          <div class="col-md-6">
            @php $subject = old('subject') ? old('subject') : $class['subject']; @endphp
            ...
            <select id="formValidationStatus" name="subject" class="form-control">
              ...
              <option value="Relapse Prevention" @if($subject == "Relapse Prevention") selected @endif>Relapse Prevention</option>
            </select>
          ...
          <div class="col-md-6">
            @php $zoomLink = old('zoomLink') ? old('zoomLink') : $class['zoomLink']; @endphp
            <label class="form-label" for="formValidationType">Zoom Link</label><label class="text-danger">*</label>
            <input type="text" class="form-control" placeholder="Zoom Link" name="zoomLink" value="{{ $zoomLink }}" />
          ...
          <div class="col-md-6">
            @php $start_date = old('start_date') ? old('start_date') : $class['start_date']; @endphp
          ...
          <div class="col-md-6">
            @php $start_time = old('start_time') ? old('start_time') : $class['start_time']; @endphp
          ...
          <div class="col-md-6">
            @php $duration = old('duration') ? old('duration') : $class['duration']; @endphp
          ...
          <div class="col-md-6">
            @php $status = old('status') ? old('status') : $class['status']; @endphp
