      ...
      <div class="card-header flex-column flex-md-row">
        ...
        <div class="dt-action-buttons text-end pt-3 pt-md-0">
          <div class="dt-buttons"> 
            <a href="{{ route('addClient')}}" class="dt-button create-new btn btn-info" tabindex="0" aria-controls="DataTables_Table_0" type="button" aria-haspopup="dialog" aria-expanded="false">
  ...
  $('#ClientTables').DataTable({
    ...
    columnDefs: [{
      ...
      "render": function (data, type, row, meta) {
        let text="";
        let base_url="{{URL::to('/') }}";
        let edit_url =base_url+"/admin/client/edit/"+row["encrypted_id"];
        let delete_url =base_url+"/admin/client/destroy/"+row["encrypted_id"];
        return `
